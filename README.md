...
- [X]I have refactored my JavaScript to use function calls and function parameters where appropriate
- [X]I have implemented the proper variables (let, const or var) 
...
- [X]I have moved embedded and inline CSS into a css file and linked it to my HTML page
- [X]My HTML page is named index. html and JavaScript and CSS files are named based on their functional requirements for may app
- [X]I created a new feature form that allows user to send feature request
- [X]I have implemented a page layout using CSS Grids for my index page 
